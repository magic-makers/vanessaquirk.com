    ...
    <div id="main">
      ...
      <div className="inner">
        ...
        <p>
          ...
          <a href="http://www.eric-jaffe.com/home">Eric Jaffe</a> and I explore
          the ideas and innovations that will transform cities; the{' '}
          <a href="https://sidewalklabs.com/podcast/">Sidewalk Weekly</a>, where
          Eric and I cover the week’s top stories in urban tech;{' '}
        ...
        <p>
          ...
          Oxford University in the U.K., left the northern hemisphere to pasarlo
          chancho in Chile, and then moved back to New York in 2014 to pursue an
